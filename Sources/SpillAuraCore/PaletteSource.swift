...
public struct PaletteSource: LightSource {
    public let aura: Aura

    public init(aura: Aura) { self.aura = aura }

    public func nextColors(channelCount: Int, at timestamp: TimeInterval) -> [(channel: UInt8, r: Float, g: Float, b: Float)] {
